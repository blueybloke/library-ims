package com.maxphillipsdev.library.views.addbook;
...
@Route(value = "add", layout = MainView.class)
@PageTitle("Add Book")
@CssImport("styles/views/addbook/add-book-view.css")
public class AddBookView extends Div {
