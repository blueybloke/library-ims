package com.maxphillipsdev.library.views.libraryinventory;

import org.springframework.beans.factory.annotation.Autowired;
import com.maxphillipsdev.library.backend.BackendService;
import com.maxphillipsdev.library.backend.Employee;
...
import com.maxphillipsdev.library.views.main.MainView;

@Route(value = "inventory", layout = MainView.class)
@PageTitle("Library Inventory")
@CssImport("styles/views/libraryinventory/library-inventory-view.css")
public class LibraryInventoryView extends Div implements AfterNavigationObserver {
    @Autowired
    ...
    public LibraryInventoryView() {
        setId("library-inventory-view");
        // Configure Grid
        employees = new Grid<>();
